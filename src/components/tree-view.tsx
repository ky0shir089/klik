  ...
  return (
    ...
    >
      <AccordionPrimitive.Item value={item.id}>
        ...
        <AccordionContent className="pl-1 ml-4 border-l">
          <TreeItem
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header>
    <AccordionPrimitive.Trigger
      ...
      {...props}
    >
      <ChevronRight className="w-4 h-4 mr-1 transition-transform duration-200 shrink-0 text-accent-foreground/50" />
      {children}
    </AccordionPrimitive.Trigger>
  </AccordionPrimitive.Header>
));
...
const TreeIcon = ({
  ...
  return Icon ? <Icon className="w-4 h-4 mr-2 shrink-0" /> : <></>;
};
