...
import { lpjSchemaType } from "@/lib/formSchema";
...
const LpjDetailRow = memo(
  ({
    ...
    const { control, setValue, getValues } = useFormContext<lpjSchemaType>();
...
LpjDetailRow.displayName = "LpjDetailRow";

export const defaultDetailItem: lpjSchemaType["details"][number] = {
  id: null,
  inv_coa_id: 0,
  description: "",
  item_amount: null,
...
const LpjDetail = ({ coas, pphs }: iAppProps) => {
  const { control } = useFormContext<lpjSchemaType>();
